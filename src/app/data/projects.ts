...
export const PROJECT_DATA: Record<string, Project> = {
    tattoo: {
        ...
        description: "Designed and developed a web application that streamlined the client's workflow from multiple platforms to a single location. Created a custom CRM for administrators to access their data and review, manage, and schedule appointments. Developed a custom calendar UI for the team to manage their consultations and appointments as well as add new custom calendar events."
    },
    records: {
        name: 'Gen. Records',
        ...
        description: "Designed and developed a functional e-commerce website that fetches album information from Spotify's API to represent the product sold. Equipped with Stripe integration for secure payments, Redux for global state management, a custom CMS to allow administrators to easily manage product and inventory levels, and user authentication with specific role privileges.",
    ...
    linkuistix: {
        ...
        description: "Collaborated on a word association game powered by a pre-trained AI model from TensorFlow. Led game development which was designed using core Object Oriented Programming principles."
    },
    dashboard: {
        ...
        description: "Developed a web application to help users track the finances of their company. It displays key performance indicators (KPIs) and other data information using multiple charts and tables, such as line, pie, and bar charts.",
